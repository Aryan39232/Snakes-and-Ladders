...
const Settings = () => {
  ...
  return (
    <div className="overflow-hidden bg-amber-50 shadow rounded-lg w-1/2 m-auto mt-20 settings-container">
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-lg font-medium leading-6 text-gray-900">
          Game Settings
        </h3>
        <p className="mt-1 max-w-2xl text-sm text-gray-500">
          Customize game settings before playing!
        </p>
      </div>
      <div className="border-t border-gray-200">
        <dl>
          ...
          {/* Total Players */}
          {/* Total Players (Fixed 5) */}
          <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt className="text-sm font-medium text-gray-500">Players</dt>
            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0 grid grid-cols-1 gap-2">
              {[...Array(5)].map((_, index) => (
                <TextField
                  key={index}
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                          ...
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              Are you sure you want to continue with this info?
                              You can get back to main menu in game!
                            </p>
                          </div>
                        </div>
                      </div>
