...
const Board = () => {
  ...
  const { name, players, check, items, playerNames } = state;
      ...
      <div className="board-image-container">
        ...
        <div
          ...
          style={{
            ...
            left: player1LeftPosition,
            bottom: player1BottomPosition,
          }}
        ></div>
        <div
          className="player-2"
          style={{
            ...
            left: player2LeftPosition,
            bottom: player2BottomPosition,
          }}
        ></div>
        <div
          className="player-3"
          style={{
            backgroundColor: player3Color,
            left: player3LeftPosition,
            bottom: player3BottomPosition,
          }}
        ></div>
        <div
          className="player-4"
          style={{
            backgroundColor: player4Color,
            left: player4LeftPosition,
            bottom: player4BottomPosition,
          }}
        ></div>
        <div
          className="player-5"
          style={{
            backgroundColor: player5Color,
            left: player5LeftPosition,
            bottom: player5BottomPosition,
          }}
        ></div>
      </div>
      <div>
        <div className="stats-container">
          <div className="stats">
            ...
            {[...Array(5)].map((_, index) => {
              const name = state?.playerNames?.[index] || `Player ${index + 1}`;
              return (
                <h2 key={index}>
                  {name}: <span>{playersLocations?.[index]}</span>
                </h2>
              );
            })}
          </div>
        ...
        <div className="winner-container">
          <div className="winner">
            <h4>
              Winner is: <span>{winnerText}</span>
            </h4>
          </div>
        </div>
        <div className="dice-container">
          <Dice
            rollingTime={1300}
            size={150}
            onRoll={(value) => handleRoll(value)}
          />
        </div>
      </div>
      {win ? <Particles options={options} {...particlesInit} /> : null}
      <div onClick={() => setDialog(true)} className="close">
        <CloseIcon
          className="h-12 w-12 text-white m-auto close-icon"
          aria-hidden="true"
        />
      </div>
      <div className="save" onClick={() => handleSave()}>
        <SaveIcon
          className="h-12 w-12 text-white m-auto save-icon"
          aria-hidden="true"
        />
      </div>
      {dialog ? (
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                          ...
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              Are you sure you want to quit this game? any
                              unsaved progress will be lost and you will go to
                              main menu.
                            </p>
                          </div>
                        </div>
